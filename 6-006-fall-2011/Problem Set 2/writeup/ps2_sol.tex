...
At level i, there are $3 \cdot 4^i$ nodes needs to be rendered, and the cost of rendering
is $(\frac{1}{9})^{i+1}$. So the overall cost is equal to $\sum\limits_{i=1}^n \frac{1}{3} \cdot \frac{1}{9} \cdot (\frac{4}{9})^i$.
The upper bound of this formula is just a constant. 
